/**
 * Builds the week data filtering or adding results.
 * 
 * @param {object} data The raw data with all races for a given period of time.
 * @returns {object} An object with the week stats data.
 */
export const weekDataBuild = (data) => {
    let newData = {};
    ...
    newData.totalLaps = data.reduce((acc, val) => { return acc + val.totalLaps}, 0);
